...
const InviteOthers = () => {
 ...
 <div class="flex space-x-4 text-blue-500 ..."></div>
        ...
        <div className="text-right px-32">
          ...
          <input type="text" placeholder='example@company.com'   name="email" className='border-2 rounded-2xl placeholder:text-[#d7d7d7] px-3 py-2 border-[#dfdfdf] outline-none w-full'/>
        </div>
